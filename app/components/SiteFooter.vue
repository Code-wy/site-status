  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> DORAEMON </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/Code-wy/site-status",
  home: "https://www.doraemon.press/",
  email: "mailto:doraemon1999@yeah.net",
};
</script>
